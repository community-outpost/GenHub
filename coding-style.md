...
- **Braces**: Always use braces `{}` for all control blocks, even for single-line statements.
	Use Allman braces style (opening brace on their own line with same indentation as the declaration).
