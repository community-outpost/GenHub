...
/// </summary>
public interface IGameManifestPool
{
    /// <summary>
    /// Adds a GameManifest to the pool after content acquisition.
    /// </summary>
    /// <param name="manifest">The game manifest to store.</param>
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    Task AddManifestAsync(GameManifest manifest, CancellationToken cancellationToken = default);

    /// <summary>
    /// Retrieves a specific GameManifest from the pool by ID.
    /// </summary>
    ...
    Task<GameManifest?> GetManifestAsync(string manifestId, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<GameManifest>> GetAllManifestsAsync(CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<GameManifest>> SearchManifestsAsync(ContentSearchQuery query, CancellationToken cancellationToken = default);

    /// <summary>
    /// Removes a GameManifest from the pool.
    /// </summary>
    ...
    /// <summary>
    /// Checks if a specific GameManifest is already acquired and stored in the pool.
    /// </summary>
    /// <param name="manifestId">The unique identifier of the manifest.</param>
    /// <param name="cancellationToken">A token to cancel the operation.</param>
