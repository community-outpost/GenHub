...
public interface IContentOrchestrator
{
    ...
    /// <summary>
    /// Resolves a <see cref="ContentSearchResult"/> item into a full <see cref="GameManifest"/>.
    /// </summary>
    ...
    Task<ContentOperationResult<GameManifest>> GetContentManifestAsync(
        string providerName,
        string contentId,
    ...
    Task<ContentOperationResult<IEnumerable<GameManifest>>> GetAcquiredContentAsync(
        CancellationToken cancellationToken = default);
