...
/// <summary>
/// Delivers actual content files based on a GameManifest.
...
public interface IContentDeliverer : IContentSource
{
    ...
    bool CanDeliver(GameManifest manifest);
    ...
    Task<ContentOperationResult<GameManifest>> DeliverContentAsync(
