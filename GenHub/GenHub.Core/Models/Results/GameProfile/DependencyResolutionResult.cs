...
public class DependencyResolutionResult : ResultBase
{
    ...
    public static DependencyResolutionResult CreateSuccess(
        ...
        TimeSpan elapsed = default)
    {
        return new DependencyResolutionResult(true, resolvedContentIds, resolvedManifests, missingContentIds, null, elapsed);
    }
    ...
    {
        return new DependencyResolutionResult(false, Array.Empty<string>(), Array.Empty<ContentManifest>(), Array.Empty<string>(), new[] { error }, elapsed);
    }
