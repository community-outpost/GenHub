...
public partial class ContentGridItemViewModel : ObservableObject
{
    ...
    /// </summary>
    public bool ShowDownloadButton => CurrentState == ContentState.NotDownloaded && !IsDownloaded;
    ...
    /// </summary>
    public bool ShowAddToProfileButton => CurrentState == ContentState.Downloaded || IsDownloaded;
