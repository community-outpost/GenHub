...
namespace GenHub.Features.Content.Services.ContentResolvers
{
    ...
    public class CNCLabsMapResolver : IContentResolver
    {
        ...
        /// <returns>A <see cref="ContentOperationResult{GameManifest}"/> containing the resolved details.</returns>
            ...
            ContentSearchResult discoveredItem, CancellationToken cancellationToken = default)
        {
            ...
            {
                return ContentOperationResult<GameManifest>.CreateFailure("Invalid discovered item or source URL");
            }
            ...
            try
            {
                ...
                {
                    return ContentOperationResult<GameManifest>.CreateFailure("No download URL found in map details");
                }
