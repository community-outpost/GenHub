...
) : IContentProvider
{
    ...
    public abstract Task<ContentOperationResult<GameManifest>> GetContentAsync(
        string contentId,
        CancellationToken cancellationToken = default);

    /// <inheritdoc/>
    public virtual async Task<ContentOperationResult<GameManifest>> PrepareContentAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        catch (Exception ex)
        {
            ...
            return ContentOperationResult<GameManifest>.CreateFailure($"Content preparation failed: {ex.Message}");
        }
    }
    ...
    protected abstract Task<ContentOperationResult<GameManifest>> PrepareContentInternalAsync(
        GameManifest manifest,
        string workingDirectory,
    ...
    private ContentSearchResult CreateResolvedSearchResult(ContentSearchResult discovered, GameManifest manifest)
    {
