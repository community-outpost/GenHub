...
public class ModDBContentProvider : BaseContentProvider
{
        ...
        string contentId, CancellationToken cancellationToken = default)
    {
        ...
        {
            return ContentOperationResult<GameManifest>.CreateFailure("Content ID cannot be null or empty");
        }
        ...
        return manifest != null
            ...
            : ContentOperationResult<GameManifest>.CreateFailure($"Invalid manifest data for content ID '{contentId}'");
    }
