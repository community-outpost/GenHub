    ...
    ILogger<CommunityOutpostResolver> logger) : IContentResolver
{
    ...
    private readonly IProviderDefinitionLoader _providerLoader = providerLoader;
    private readonly ILogger<CommunityOutpostResolver> _logger = logger;
    ...
    /// </summary>
    private static List<string> GetMirrorUrls(ContentSearchResult item)
    {
