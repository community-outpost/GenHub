...
public class ContentStorageService : IContentStorageService
{
    ...
    public ContentStorageService(ILogger<ContentStorageService> logger, IConfigurationProvider configurationProvider)
    {
        _logger = logger;
    ...
    private async Task<GameManifest> StoreContentFilesAsync(
        GameManifest manifest,
        string sourceDirectory,
