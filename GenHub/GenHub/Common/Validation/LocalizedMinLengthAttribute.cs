...
/// <summary>
/// Minimum-length attribute with a localized error message.
/// </summary>
...
public sealed class LocalizedMinLengthAttribute : MinLengthAttribute
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LocalizedMinLengthAttribute"/> class.
    /// </summary>
    ...
    public LocalizedMinLengthAttribute(int length, string resourceKey, string fallbackMessage)
        : base(length)
    {
