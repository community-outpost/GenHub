...
namespace GenHub.Tests.Core.Features.GameProfiles
{
    ...
    {
        private readonly Mock<IGameProfileRepository> _profileRepositoryMock;
        ...
        private readonly Mock<ILogger<GameProfileManager>> _loggerMock;
        ...
        {
            _profileRepositoryMock = new Mock<IGameProfileRepository>();
            _installationServiceMock = new Mock<IGameInstallationService>();
            _manifestPoolMock = new Mock<IContentManifestPool>();
            _loggerMock = new Mock<ILogger<GameProfileManager>>();
        ...
        public async Task GetAllProfilesAsync_Should_ReturnAllProfiles()
        {
            ...
            {
                new() { Id = "1", Name = "Profile 1", GameInstallationId = "install-1", GameVersionId = "version-1", GameVersion = new GameVersion { Id = "version-1" } },
                new() { Id = "2", Name = "Profile 2", GameInstallationId = "install-2", GameVersionId = "version-2", GameVersion = new GameVersion { Id = "version-2" } },
                new() { Id = "3", Name = "Profile 3", GameInstallationId = "install-3", GameVersionId = "version-3", GameVersion = new GameVersion { Id = "version-3" } },
            };
