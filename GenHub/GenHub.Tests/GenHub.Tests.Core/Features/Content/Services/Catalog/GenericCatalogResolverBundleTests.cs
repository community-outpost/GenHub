...
/// </summary>
public sealed class GenericCatalogResolverBundleTests
{
    /// <summary>
    ...
    public async Task ResolveAsync_BaseGameDependency_WithRangeConstraint_EmitsBoundsAndInclusivityAsync()
    {
        ...
        builderMock.Setup(b => b.AddDependency(
                ...
                It.IsAny<bool>(),
                It.IsAny<string?>()))
            .Callback<ManifestId, string, ContentType, DependencyInstallBehavior, string, string, List<string>?, bool, List<ManifestId>?, List<GameType>?, bool, bool, bool, string?>((id, name, type, behavior, min, max, comp, excl, conf, games, minInc, maxInc, strictPub, pubType) =>
                builtManifest.Dependencies.Add(new ContentDependency
                {
                    Id = id,
                    Name = name,
    ...
    public async Task ResolveAsync_ContentBundle_EmitsFoundationAndSiblingGameClientIdsAsync()
    {
        ...
        var expectedClientId = CatalogManifestIdentity.CreateContentId(
            CatalogManifestIdentity.ResolveDeclaredPublisherType("genhub-test-publishers"),
    ...
    public async Task ResolveAsync_DependencyWithoutPublisherId_InheritsDeclaredHostPublisherAsync()
    {
        ...
        builderMock.Setup(b => b.AddDependency(
                ...
                It.IsAny<bool>()))
            .Callback<ManifestId, string, ContentType, DependencyInstallBehavior, string, string, List<string>?, bool, List<ManifestId>?, List<GameType>?, bool, bool>(
                (id, name, type, behavior, min, max, comp, excl, conf, games, minInc, maxInc) => capturedId = id)
            .Returns(builderMock.Object);
        builderMock.Setup(b => b.AddDependency(
                It.IsAny<ManifestId>(),
                It.IsAny<string>(),
                ...
                It.IsAny<string?>()))
            .Callback<ManifestId, string, ContentType, DependencyInstallBehavior, string, string, List<string>?, bool, List<ManifestId>?, List<GameType>?, bool, bool, bool, string?>(
                (id, name, type, behavior, min, max, comp, excl, conf, games, minInc, maxInc, strictPub, pubType) => capturedId = id)
            .Returns(builderMock.Object);
    ...
    public async Task ResolveAsync_DependencyWithoutPublisherId_AndNoHostPublisher_InheritsGenericCatalogResolverIdAsync()
    {
        ...
        builderMock.Setup(b => b.AddDependency(
                ...
                It.IsAny<bool>(),
                It.IsAny<bool>()))
            .Callback<ManifestId, string, ContentType, DependencyInstallBehavior, string, string, List<string>?, bool, List<ManifestId>?, List<GameType>?, bool, bool>((id, name, type, behavior, min, max, comp, excl, conf, games, minInc, maxInc) => capturedId = id)
            .Returns(builderMock.Object);
        builderMock.Setup(b => b.AddDependency(
                It.IsAny<ManifestId>(),
                It.IsAny<string>(),
                ...
                It.IsAny<bool>(),
                It.IsAny<string?>()))
            .Callback<ManifestId, string, ContentType, DependencyInstallBehavior, string, string, List<string>?, bool, List<ManifestId>?, List<GameType>?, bool, bool, bool, string?>((id, name, type, behavior, min, max, comp, excl, conf, games, minInc, maxInc, strictPub, pubType) => capturedId = id)
            .Returns(builderMock.Object);
