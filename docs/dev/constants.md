...
| Constant | Value | Description |
| :--- | :--- | :--- |
| `GeneralsOnlineDirectoryName` | `"Command and Conquer Generals"` | Standard Generals installation directory name |
...
#### FromInstallationType Method (Installation Source)
...
var downloadTimeout = TimeIntervals.NotificationHideDelay;
```
...
| `Description` | `"Manage, import, and share replay files for C&C: Generals/ZH."`   | Description of the Replay Manager tool                                               |
| `Tags`        | `["replays", "file-management", "sharing"]`                        | Tags associated with the Replay Manager tool                                         |
| `IconPath`    | `"Assets/Icons/replay.png"`                                        | Icon path for the Replay Manager tool                                                |
